$(document).ready(function() {
    ...
    let countDown = new Date('May 1, 2022 00:00:00').getTime(),
        ...
        Object.values(cartItems).map(item => {
            ...
            <td><span> ${item.name}</span></td>
             ...
             <td id="incart_${item.name}">
                <button type="button" class="btn buttonChange" id="sub" data-itemId="${item.name}" onclick = "sub('${item.id}')"><ion-icon name="remove-circle-outline"></ion-icon></button>
                <span>${item.incart}</span>
                <button type="button" class="btn buttonChange" id="add" data-itemId="${item.name}" onclick = "add('${item.id}')"><ion-icon name="add-circle-outline"></ion-icon></button>
             </td>
